...
class ProviderClient(ABC, Generic[TConfig]):
    ...
    async def _generate_struct(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            response_format: Pydantic model class to validate the response against
    ...
    async def generate_struct(
        ...
        **kwargs: Any,
        ...
        """Public wrapper for structured LLM calls (validated Pydantic output)."""
        ...
        async with self._semaphore:
            ...
            try:
                result = await self._generate_struct(
                    model=model,
                    messages=messages,
                ...
                if logger is not None:
                    ...
                    logger.debug("Struct LLM call succeeded", data=log_data, metadata=log_metadata)
                ...
                if logger is not None:
                    ...
                    logger.debug("Struct LLM call failed", data=log_data, metadata=log_metadata)
                raise
